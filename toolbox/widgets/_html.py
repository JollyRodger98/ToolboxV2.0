...
table_col_head_template: Markup = Markup("<th class=\"text-nowrap %(head_class)s\" scope=\"col\">%(head_content)s</th>")

table_row_head_template: Markup = Markup("<th class=\"text-nowrap %(head_class)s\" scope=\"row\">%(head_content)s</th>")
